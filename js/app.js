...
App.COMPONENT_TONE = {
  ...
  MemoryComponent: "time",
  Multiplexor: "time",
  Demultiplexor: "time",
  SequentialSwitch: "time",
  SequentialDemux: "time",
  Mouse: "control",
  KeyboardComponent: "control",
  PolyphonicKeyboard: "control",
  JoystickComponent: "control",
  PhoneSensors: "control",
  Midi: "control",
  WebRTCSender: "control",
  WebRTCReceiver: "control",
  NumberDisplayComponent: "visual",
  FrequencyAnalizer: "visual",
  Spectrogram: "visual",
  Oscilloscope: "visual",
  LargeVisualizer: "visual",
  PeakDetectorComponent: "visual",
  PitchDetectorComponent: "visual",
  Spectrum2Image: "visual",
  ImageMaker: "visual",
  CanvasPlotter: "visual",
  Shader: "visual",
  Text: "meta",
  RackCover: "meta",
  Merger: "meta",
